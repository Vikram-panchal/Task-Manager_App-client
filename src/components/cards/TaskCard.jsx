...
const TaskCard = ({
  ...
  return (
    <div
      className="bg-white shadow-gray-100 rounded-xl shadow-md py-4 border border-gray-200/50 cursor-pointer "
      onClick={onClick}
    >
      ...
      >
        ...
        <p className="text-xs text-gray-500 line-clamp-2 mt-1.5 leading-[18px]">
          {description}
        </p>

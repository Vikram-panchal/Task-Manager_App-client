...
const Modal = ({ children, onClose, isOpen, title }) => {
  if (!isOpen) return;
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center w-full h-[calc(100%-1rem)] max-h-full overflow-y-auto overflow-x-hidden bg-black/200 bg-opacity-50">
